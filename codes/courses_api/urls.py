...
urlpatterns = [
    ...
    path("flashcard/read/<str:lessonId>/<int:pk>/",views.flashcard_read,name="flashcard-read"),
    path("flashcard/update/<str:lessonId>/<int:pk>/",views.flashcard_update,name="flashcard-update"),
    path("flashcard/delete/<str:lessonId>/<int:pk>/",views.flashcard_delete,name="flashcard-delete")
]